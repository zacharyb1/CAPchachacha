...
st.set_page_config(page_title="Perfect Circle Captcha", page_icon="⭕️", layout="centered")


def circle_draw_captcha():
    st.title("⭕️ Draw a Perfect Circle Captcha")
    st.caption("Instruction: Draw a perfect circle with your mouse. This always fails. Sorry.")
